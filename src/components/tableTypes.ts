...
type TailwindColorVariant =
	...
	| "900"
	| "950";
type TailwindRadiusSizeVariant =
	| "none"
	| "sm"
	| "md"
	| "lg"
	...
	| "3xl"
	| "full";
type TailwindRadiusDirectionsVariant =
	| "t"
	| "r"
	| "b"
	| "l"
...
export type TStyle = {
	rounded?:
		...
		| `${
				| "rounded-"
				| `rounded-${TailwindRadiusDirectionsVariant}-`}${TailwindRadiusSizeVariant}`;
	border?:
	...
	text?:
		| "text-inherit"
		| `text-${TailwindUniqueColor}`
		| `text-${TailwindColor}-${TailwindColorVariant}`;
	placeholder?: string;
	background?:
		| "bg-inherit"
		| `bg-${TailwindUniqueColor}`
		| `bg-${TailwindColor}-${TailwindColorVariant}`;
